...
let openPopupButtons = document.querySelectorAll('.open_popup'); // Кнопки для показа окна
let closePopupButton = document.querySelector('.close_popup'); // Кнопка для скрытия окна
...
openPopupButtons.forEach((button) => { // Перебираем все кнопки
    button.addEventListener('click', (e) => { // Для каждой вешаем обработчик событий на клик
		...
		document.body.style.overflow = 'hidden'; // отключает прокрутку скрола у body
    })	
});
...
closePopupButton.addEventListener('click',() => { // Вешаем обработчик на крестик
	...
	document.body.style.overflow = ''; // включает прокрутку скрола у body
});
